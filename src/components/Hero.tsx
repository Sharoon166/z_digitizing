  ...
  return (
    <section className="py-24 flex flex-col md:flex-row items-center justify-around gap-8">
      <div className="max-w-3xl mx-auto md:px-8 md:w-[60%] max-md:text-center">
        <h2 className="text-4xl md:text-6xl font-bold mb-2 text-pretty">
        ...
        <p className="text-sm md:text-base text-gray-600 mb-8 text-balance">
        ...
        <div>
          <button className="hover:bg-mustard text-zinc-800 px-8 py-3 border-2 border-mustard transition-colors mx-auto block md:inline-block">
            Get in touch
          </button>
        </div>
      </div>
